            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-lg-auto my-2 my-lg-0 navbar-nav-scroll">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{url('first')}}">Home9</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="#blog" class="zoom d-block">
                                    <img class="card-img-bottom d-block" src="{{url('/public/assets/img/g3.jpg')}}" alt="Card image cap">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 item mt-md-0 mt-5">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="#blog" class="zoom d-block">
                                    <img class="card-img-bottom d-block" src="{{url('/public/assets/img/g4.jpg')}}" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">
